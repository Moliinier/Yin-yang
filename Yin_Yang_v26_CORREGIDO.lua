--[[
    Yin Yang - UI Ultimate Edition (v26)
    ============================================================
    NUEVAS CARACTERÍSTICAS:
    
    1. LOGO YIN-YANG ROTATIVO
...
print("✅ Yin Yang v26 - ¡Librería cargada y lista para usar!")
...
if DEMO_ACTIVO then
    ...
    print("\n" .. string.rep("=", 60))
    print("INICIANDO DEMO VISUAL DE YIN YANG v26")
    print(string.rep("=", 60))
    ...
    local DemoUI = _G.YinYang:CreateWindow("Yin Yang v26", TemaInicial)
    ...
    TabTemas:CreateButton("Temas Personalizados", function() end)
    ...
    TabEfectos:CreateButton("Blanco - Celeste", function()
        ...
        print("Efecto: Pulso suave")
    end)
    
    TabEfectos:CreateButton("Blanco - Rosa", function()
        DemoUI:SetTextEffect("WhitePink")
        print("Efecto: Pulso lento")
    end)
    
    TabEfectos:CreateButton("Rainbow Completo", function()
        DemoUI:SetTextEffect("Rainbow")
        print("Efecto: Espectro completo")
    end)

    TabEfectos:CreateButton("Dark - White", function()
        DemoUI:SetTextEffect("RainbowDarkWhite")
        print("Efecto: Transicion Negro a Blanco")
    end)
    
    print("\n✅ DEMO v26 INICIADA")
    print("TABS: Inicio (Sagrada) | Temas (Sagrada) | Features | Dropdowns | Efectos")
    ...
    DemoUI:SetTextEffect("Rainbow")
    print("Yin Yang v26 - Tema Dark + Rainbow aplicado")
else
    print("Yin Yang v26 - DEMO DESACTIVADA (DEMO_ACTIVO = false)")
    print("Solo la libreria esta cargada y lista para usar")
end
