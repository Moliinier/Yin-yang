...
print("\nCargando Yin Yang v26.1 UPGRADED (Premium Floating Toggles)...")
...
TabMovement:CreateFloatingToggle("Infinite Slide", false, function(state)
    Config.InfiniteSlide = state
    print(state and "✅ Infinite Slide ACTIVADO" or "❌ Infinite Slide DESACTIVADO")
end)

TabMovement:CreateFloatingToggle("Auto Dash", false, function(state)
    Config.AutoDash = state
    print(state and "✅ Auto Dash ACTIVADO - Ráfagas de velocidad" or "❌ Auto Dash DESACTIVADO")
end)

TabMovement:CreateFloatingToggle("Auto Jump", false, function(state)
    Config.AutoJump = state
    print(state and "✅ Auto Jump ACTIVADO - Saltos automáticos" or "❌ Auto Jump DESACTIVADO")
end)

TabMovement:CreateDivider()

TabMovement:CreateFloatingToggle("Teleport Walk Mode", false, function(state)
    Config.EnableTeleportWalk = state
    print(state and "✅ Teleport Walk Mode ACTIVADO - Teleportate mientras te mueves" or "❌ Teleport Walk Mode DESACTIVADO")
end)
...
TabMovement:CreateFloatingToggle("Enhanced Jump", false, function(state)
    ...
    print(state and "✅ Enhanced Jump ACTIVADO - Salta más alto" or "❌ Enhanced Jump DESACTIVADO")
end)
...
TabFarming:CreateFloatingToggle("AFK Mode", false, function(state)
...
TabFarming:CreateFloatingToggle("Auto Carry", false, function(state)
