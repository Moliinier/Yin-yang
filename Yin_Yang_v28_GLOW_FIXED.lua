...
local function buildAnimatedBorder(frame, accentColor, cornerRadius, forceStrokeOnly)
    ...
    local _, outerStroke = addGlowSibling(frame, 6, 0.60, accentColor, cr)
    local _, innerStroke = addGlowSibling(frame, 2, 0.25, accentLight, cr)
