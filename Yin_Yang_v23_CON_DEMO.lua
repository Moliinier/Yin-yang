--[[
    Yin Yang - UI Ultimate Edition (v23)
    ============================================================
...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    --// ════════════════════════════════════════════════════════════
    --// FUNCIÓN: Crear TAB INICIO (FIJO - No se puede eliminar)
    --// ════════════════════════════════════════════════════════════
    local function createStartTab()
    ...
    --// ════════════════════════════════════════════════════════════
    --// FUNCIÓN: Crear TAB TEMAS (FIJO - No se puede eliminar)
    --// ════════════════════════════════════════════════════════════
    local function createThemesTab()
        local TabButton = mk("TextButton", {
            Size = UDim2.new(1, 0, 0, 32),
        ...
        for themeName, palette in pairs(ThemePalettes) do
            ...
            ThemeButton.MouseButton1Click:Connect(function()
                ...
                ThemeButton.TextColor3 = Theme.AccentText
    ...
    -- Tab de Inicio (siempre primero)
    local StartTab = createStartTab()
    table.insert(Window.Tabs, 1, StartTab)
    
    -- Tab de Temas (siempre segundo)
    local ThemesTab = createThemesTab()
...
print("✅ Yin Yang v23 - ¡Librería cargada y lista para usar!")
...
--// - Para DESACTIVAR: Cambia "DEMO_ACTIVO" a false o elimina todo este bloque
--// ============================================================

local DEMO_ACTIVO = true  -- ⚡ CAMBIAR AQUÍ PARA ACTIVAR/DESACTIVAR

if DEMO_ACTIVO then
    wait(0.5)  -- Esperar a que cargue
    
    print("\n" .. string.rep("=", 60))
    print("🎨 INICIANDO DEMO VISUAL DE YIN YANG v23")
    print(string.rep("=", 60))
    
    -- Crear ventana de demostración
    local DemoUI = _G.YinYang:CreateWindow("Yin Yang - DEMO", "Dark")
    ...
    TabInicio:CreateLabel("✨ Bienvenido a la DEMO de Yin Yang", 16)
    TabInicio:CreateDivider()
    TabInicio:CreateLabel("Esta es una demostración interactiva de todas las características disponibles. Explora los diferentes tabs para ver qué puedes hacer.", 12)
    TabInicio:CreateDivider()
    
    TabInicio:CreateLabel("📋 Qué encontrarás:", 14)
    TabInicio:CreateLabel("• Toggles activables/desactivables\n• Botones con acciones\n• Dropdowns con opciones\n• Cambio de temas dinámicos\n• Efectos de texto animados\n• Información del servidor", 11)
    TabInicio:CreateDivider()
    
    TabInicio:CreateButton("❤️ Haz clic para demostrar el sonido", function()
        print("🔊 ¡Sonido de demostración!")
    end)
    
    -- =========================================================
    -- TAB 2: TOGGLES DEMOSTRACIÓN
    -- =========================================================
    local TabToggles = DemoUI:CreateTab("🎚️ Toggles")
    
    TabToggles:CreateLabel("Prueba los toggles - se activan/desactivan con sonido", 13)
    TabToggles:CreateDivider()
    
    TabToggles:CreateToggle("🎯 Aimbot", false, function(state)
        print("Aimbot: " .. (state and "✅ ACTIVADO" or "❌ DESACTIVADO"))
    end)
    
    TabToggles:CreateToggle("👁️ ESP (Ver enemigos)", false, function(state)
        print("ESP: " .. (state and "✅ ACTIVADO" or "❌ DESACTIVADO"))
    end)
    
    TabToggles:CreateToggle("⚔️ God Mode", false, function(state)
        print("God Mode: " .. (state and "✅ ACTIVADO" or "❌ DESACTIVADO"))
    end)
    
    TabToggles:CreateToggle("💨 Velocidad x2", false, function(state)
        print("Velocidad: " .. (state and "✅ ACTIVADO" or "❌ DESACTIVADO"))
    end)
    
    TabToggles:CreateToggle("👻 Invisibilidad", false, function(state)
        print("Invisibilidad: " .. (state and "✅ ACTIVADO" or "❌ DESACTIVADO"))
    end)
    
    TabToggles:CreateDivider()
    TabToggles:CreateLabel("💡 Tip: Abre la ventana del Inspector de Salida para ver los mensajes de estado", 11)
    
    -- =========================================================
    -- TAB 3: BOTONES Y ACCIONES
    -- =========================================================
    local TabBotones = DemoUI:CreateTab("🔘 Botones")
    
    TabBotones:CreateLabel("Haz clic en los botones para ver acciones", 13)
    TabBotones:CreateDivider()
    
    TabBotones:CreateButton("📍 Teleportarme al spawn", function()
        print("📍 ¡Teleportándote al spawn!")
    end)
    
    TabBotones:CreateButton("💰 Sumar 1000 monedas", function()
        print("💰 +1000 monedas agregadas")
    end)
    
    TabBotones:CreateButton("🏆 Ganar XP", function()
        print("🏆 +500 XP ganados")
    end)
    
    TabBotones:CreateDivider()
    
    TabBotones:CreateButton("⚡ Ejecutar acción especial", function()
        print("⚡ Acción especial ejecutada")
    end)
    
    -- =========================================================
    -- TAB 4: CONTROLES
    -- =========================================================
    local TabControles = DemoUI:CreateTab("⚙️ Controles")
    
    TabControles:CreateLabel("Personaliza tu experiencia", 13)
    TabControles:CreateDivider()
    
    TabControles:CreateDropdown("🎨 Tema Visual", {"Dark", "Light", "Purple", "Blue", "Green", "Red", "Orange", "Pink"}, "Dark", function(theme)
        DemoUI:SetTheme(theme)
        print("🎨 Tema cambiado a: " .. theme)
    end)
    
    TabControles:CreateDivider()
    
    TabControles:CreateDropdown("✨ Efecto de Texto", {"Off", "WhiteCyan", "WhitePink", "Rainbow"}, "Off", function(effect)
        DemoUI:SetTextEffect(effect)
        print("✨ Efecto de texto: " .. effect)
    end)
    
    TabControles:CreateDivider()
    
    TabControles:CreateLabel("🔊 Volumen de Sonidos", 12)
    TabControles:CreateLabel("(Actualmente: 100%)", 11)
    
    TabControles:CreateDivider()
    
    TabControles:CreateButton("📖 Ver documentación", function()
        print("📖 Abre la consola de desarrollador para ver más info")
        print("_G.YinYang es la librería global disponible")
    end)
    
    -- =========================================================
    -- TAB 5: INFORMACIÓN
    -- =========================================================
    local TabInfo = DemoUI:CreateTab("ℹ️ Info")
    
    TabInfo:CreateLabel("Acerca de Yin Yang v23", 14)
    TabInfo:CreateDivider()
    
    TabInfo:CreateLabel("📚 Librería UI profesional para Roblox", 12)
    TabInfo:CreateLabel("Creada en Lua", 11)
    TabInfo:CreateDivider()
    
    TabInfo:CreateLabel("✨ Características principales:", 12)
    TabInfo:CreateLabel("✅ Logo Yin-Yang rotativo animado\n✅ Sonidos integrados profesionales\n✅ 8 temas de color predefinidos\n✅ Efectos de texto dinámicos\n✅ Cambio de tema en tiempo real\n✅ Dropdowns con múltiples opciones\n✅ Toggles con estado persistente\n✅ Botones clickeables personalizables\n✅ Interfaz responsiva y fluida", 10)
    
    TabInfo:CreateDivider()
    
    TabInfo:CreateButton("💻 Ver código", function()
        print("\n" .. string.rep("-", 60))
        print("Para usar Yin Yang en tu proyecto:")
        print(string.rep("-", 60))
        print("local YinYang = _G.YinYang")
        print("local UI = YinYang:CreateWindow('Mi App', 'Dark')")
        print("local Tab = UI:CreateTab('Inicio')")
        print("Tab:CreateToggle('Mi Toggle', false, function(state)")
        print("    print('Estado: ' .. tostring(state))")
        print("end)")
        print(string.rep("-", 60) .. "\n")
    end)
    
    print("\n✅ DEMO Iniciada correctamente")
    print("📝 Busca la UI en la pantalla y comienza a explorar")
