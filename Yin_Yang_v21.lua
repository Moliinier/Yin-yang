...
TabSettings:CreateButton("Cambiar a Pink", function()
    Zero:SetTheme("Pink")
    print("✓ Tema cambiado a Pink")
end)

TabSettings:CreateButton("Cambiar a White", function()
    Zero:SetTheme("Light")
    print("✓ Tema cambiado a White")
end)

TabSettings:CreateDivider()
TabSettings:CreateLabel("✨ Nuevos Temas V2 & V3:", 12)
TabSettings:CreateDivider()

TabSettings:CreateButton("DarkV2", function()
    Zero:SetTheme("DarkV2")
    print("✓ Tema cambiado a DarkV2")
end)

TabSettings:CreateButton("BlueV2", function()
    Zero:SetTheme("BlueV2")
    print("✓ Tema cambiado a BlueV2")
end)

TabSettings:CreateButton("RedV2", function()
    Zero:SetTheme("RedV2")
    print("✓ Tema cambiado a RedV2")
end)

TabSettings:CreateButton("PinkV2", function()
    Zero:SetTheme("PinkV2")
    print("✓ Tema cambiado a PinkV2")
end)

TabSettings:CreateButton("PinkV3", function()
    Zero:SetTheme("PinkV3")
    print("✓ Tema cambiado a PinkV3")
end)

TabSettings:CreateButton("WhiteV2", function()
    Zero:SetTheme("WhiteV2")
    print("✓ Tema cambiado a WhiteV2")
end)

TabSettings:CreateButton("WhiteAndDark", function()
    Zero:SetTheme("WhiteAndDark")
    print("✓ Tema cambiado a WhiteAndDark")
end)

TabSettings:CreateButton("Green", function()
    Zero:SetTheme("Green")
    print("✓ Tema cambiado a Green")
end)

TabSettings:CreateButton("WhiteV3 (Neon)", function()
    Zero:SetTheme("WhiteV3")
    print("✓ Tema cambiado a WhiteV3 - ¡Textos NEON activos!")
end)

TabSettings:CreateDivider()
TabSettings:CreateLabel("✨ Efectos de Texto Animados:", 12)
TabSettings:CreateDivider()

TabSettings:CreateButton("Texto: Blanco ↔ Celeste", function()
    Zero:SetTextEffect("WhiteCyan")
    print("✓ Efecto de texto: Blanco-Celeste")
end)

TabSettings:CreateButton("Texto: Blanco ↔ Rosa", function()
    Zero:SetTextEffect("WhitePink")
    print("✓ Efecto de texto: Blanco-Rosa")
end)

TabSettings:CreateButton("Texto: Rainbow", function()
    Zero:SetTextEffect("Rainbow")
    print("✓ Efecto de texto: Rainbow")
end)

TabSettings:CreateButton("Texto: Desactivar Efecto", function()
    Zero:SetTextEffect("Off")
    print("✓ Efecto de texto desactivado")
end)

print("✅ Yin Yang v20 - ¡Listo!")
print("🎯 Nuevos Temas: DarkV2, BlueV2, RedV2, PinkV2, PinkV3, WhiteV2, WhiteAndDark")
print("🌈 Nuevos Efectos de Texto: WhiteCyan, WhitePink, Rainbow")
