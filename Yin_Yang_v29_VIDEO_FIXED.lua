    ...
    function Window:SetTheme(themeName)
        ...
        if themeName == "YinYangNewV1" then
            ...
            if BackgroundArt and BackgroundArt.Parent then
                ...
                BackgroundArt.ZIndex = 4  -- Atrás
            end
            if CurrentVideoFrame and CurrentVideoFrame.Parent then
                CurrentVideoFrame.Visible = true
                CurrentVideoFrame.ZIndex = 6  -- Adelante (por encima de BackgroundArt)
                ...
                if ok and videoAsset then
                    pcall(function()
                        ...
                        print("   Asset: " .. tostring(videoAsset))
            ...
            if BackgroundArt and BackgroundArt.Parent then
                ...
                BackgroundArt.ZIndex = 5  -- Adelante cuando se muestra
                CurrentVideoFrame.ZIndex = 4  -- VideoFrame atrás cuando no se usa
                pcall(function()
