--[[
    ...
    2. SONIDOS INTEGRADOS:
       ...
       - Dragón aleatorio cuando está cerrado (138517216516736)
    3. TOGGLES FLOTANTES: 
...
local Sounds = {
    ...
    Dragon = "rbxassetid://138517216516736",
}
...
function ZeroUI:CreateWindow(title_text, startTheme)
    ...
    dragonConnection = game:GetService("RunService").Heartbeat:Connect(function()
        ...
        if dragonTimer > 300 then -- Cada ~5 segundos
            dragonTimer = 0
            if not Main or not Main.Visible then
                playSound(Sounds.Dragon, 0.3)
            end
        end
    end)
...
print("🎮 Zero UI v18 Ultimate - Iniciando...")
local Zero = ZeroUI:CreateWindow("Zero UI v18 - Ultimate", "Purple")
...
print("✅ Zero UI v18 ULTIMATE - ¡Listal!")
