...
local function buildAnimatedBorder(frame, accentColor, cornerRadius)
    ...
    -- Calcular colores derivados del accentColor
    ...
    -- Animar sweep (luz que recorre el borde)
    ...
    return { OuterStroke = outerStroke, InnerStroke = innerStroke, Gradient = grad }
end
...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    function Window:CreateTab(nameSpanish, nameEnglishOrIcon, iconAsset)
        ...
        local textStart = 38
        if iconAsset then
            local iconSize = (displayName == "Chat") and 36 or 24
            local iconPos = (displayName == "Chat") and 3 or 7
            mk("ImageLabel", {
                Parent = TabButton,
