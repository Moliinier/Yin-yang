...
local TextFonts = {
    ...
    Code = Enum.Font.Nunito,              -- Fuente para código
    Elegant = Enum.Font.GothamBook,       -- Fuente elegante (más fina)
    Titulo = Enum.Font.GothamBlack,       -- Fuente de fantasía para títulos
...
if DEMO_ACTIVO then
    ...
    TabTemas:CreateButton("💻 Código (Nunito)", function()
        CurrentFont = TextFonts.Code
        print("✓ Fuente: Código profesional")
    end)
