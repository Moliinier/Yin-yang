...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    --// ✨ CONTADOR DE USUARIOS ONLINE (Verde) + OFFLINE (Gris)
    	...
    	task.spawn(function()
    		while true do
    			...
    			if success and response then
    				...
    				OnlineCounterLabel.Text = "🟢 Online: " .. tostring(onlineCount)
    				OfflineCounterLabel.Text = "⚫ Offline: " .. tostring(offlineCount)
