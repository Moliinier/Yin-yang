...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    -- Contenedor de mensajes (placeholder por ahora)
    AutoTabChatGlobal:CreateLabel("Chat global para sincronizar mensajes en tiempo real", 11)
    AutoTabChatGlobal:CreateDivider()
    AutoTabChatGlobal:CreateLabel("Nota: Requiere módulo YinYang_GlobalChat", 10)
