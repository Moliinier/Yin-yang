...
if DEMO_ACTIVO then
    ...
    print("\n" .. string.rep("=", 60))
    print("🎨 INICIANDO DEMO VISUAL DE YIN YANG v22")
    print(string.rep("=", 60))
    
    -- Crear ventana de demostración
    local DemoUI = _G.YinYang:CreateWindow("Yin Yang - DEMO v22", "Dark")
    ...
    -- =========================================================
    -- TAB 2: TOGGLES FLOTANTES
    -- =========================================================
    local TabToggles = DemoUI:CreateTab("🎚️ Toggles")
    
    TabToggles:CreateLabel("Toggles Flotantes Desprendibles", 14)
    TabToggles:CreateDivider()
    TabToggles:CreateLabel("Haz clic en la flechita ↗ para desanclar un toggle", 11)
    TabToggles:CreateDivider()
    
    TabToggles:CreateFloatingToggle("🎯 Aimbot", false, function(state)
        print("🎯 Aimbot: " .. (state and "✅ ON" or "❌ OFF"))
    end)
    
    TabToggles:CreateFloatingToggle("👁️ ESP", false, function(state)
        print("👁️ ESP: " .. (state and "✅ ON" or "❌ OFF"))
    end)
    
    TabToggles:CreateFloatingToggle("⚔️ God Mode", false, function(state)
        print("⚔️ GodMode: " .. (state and "✅ ON" or "❌ OFF"))
    end)
    
    TabToggles:CreateFloatingToggle("💨 Speed x2", false, function(state)
        print("💨 Speed: " .. (state and "✅ ON" or "❌ OFF"))
    end)
    
    TabToggles:CreateFloatingToggle("👻 Invisibilidad", false, function(state)
        print("👻 Invisibilidad: " .. (state and "✅ ON" or "❌ OFF"))
    end)
    ...
    TabDropdowns:CreateLabel("Dropdown Simple", 14)
    TabDropdowns:CreateDivider()
    
    TabDropdowns:CreateDropdown("🎯 Categoría", 
        {"Jugadores", "NPCs", "Objetos", "Animales"},
        "Jugadores",
        function(value)
    ...
    TabDropdowns:CreateDivider()
    TabDropdowns:CreateLabel("Dropdown Múltiple", 14)
    TabDropdowns:CreateDivider()
    
    TabDropdowns:CreateMultiDropdown("📦 Elementos a Bloquear",
        {"Madera", "Piedra", "Oro", "Diamante", "Plata", "Cobre"},
        {},
        function(list)
            if #list > 0 then
    ...
    TabTemas:CreateLabel("Sistema de Temas Dinámico", 14)
    TabTemas:CreateDivider()
    TabTemas:CreateLabel("Haz clic en cualquier tema para cambiar los colores en tiempo real", 11)
    TabTemas:CreateDivider()
    
    local temas = {"Dark", "Light", "Blue", "Red", "Pink", "Purple", "Orange", "Green"}
    ...
    TabEfectos:CreateLabel("Efectos de Texto Animados", 14)
    TabEfectos:CreateDivider()
    
    TabEfectos:CreateButton("✨ Blanco ↔ Celeste (WhiteCyan)", function()
        DemoUI:SetTextEffect("WhiteCyan")
        print("✨ Efecto: WhiteCyan activado")
    end)
    
    TabEfectos:CreateButton("✨ Blanco ↔ Rosa (WhitePink)", function()
        DemoUI:SetTextEffect("WhitePink")
        print("✨ Efecto: WhitePink activado")
    end)
    
    TabEfectos:CreateButton("🌈 Arcoíris (Rainbow)", function()
    ...
    TabEfectos:CreateButton("⏹️ Desactivar Efectos", function()
        DemoUI:SetTextEffect("Off")
        print("⏹️ Efectos de texto desactivados")
    end)
    ...
    TabInfo:CreateLabel("Acerca de Yin Yang v22", 14)
    TabInfo:CreateDivider()
    
    TabInfo:CreateLabel("Librería UI profesional para Roblox", 12)
    TabInfo:CreateLabel("Creada en Lua con características avanzadas", 11)
    TabInfo:CreateDivider()
    
    TabInfo:CreateLabel("✨ Características:", 12)
    TabInfo:CreateLabel("✅ Logo Yin-Yang rotativo\n✅ Sonidos integrados\n✅ 8+ temas de color\n✅ Efectos de texto dinámicos\n✅ Toggles flotantes desprendibles\n✅ Dropdowns simples y múltiples\n✅ Cambio de tema en tiempo real\n✅ Avatar del usuario\n✅ Estadísticas del servidor\n✅ Interfaz responsiva", 10)
    
    TabInfo:CreateDivider()
    
    TabInfo:CreateButton("📖 Ver Ejemplo de Código", function()
        print("\n" .. string.rep("-", 60))
        print("EJEMPLO DE USO EN TUS PROYECTOS:")
        print(string.rep("-", 60))
        print("local UI = _G.YinYang:CreateWindow('Mi App', 'Dark')")
    ...
    print(string.rep("=", 60))
    print("✨ YIN YANG v22 - DEMOSTRACIÓN LISTA PARA USAR")
    print(string.rep("=", 60))
    print("✓ Bienvenida con Avatar del Usuario")
    print("✓ Estadísticas del Servidor (Jugadores, FPS, Latencia, etc)")
    print("✓ Toggles Flotantes Desprendibles")
    print("✓ Dropdowns Simples y Múltiples")
    print("✓ 8+ Temas de Color Dinámicos")
    print("✓ 4 Efectos de Texto Animados")
    print("✓ Accesible Globalmente (_G.YinYang)")
    print("✓ Documentación Incluida")
    print(string.rep("=", 60) .. "\n")
else
    print("✅ Yin Yang v22 - ¡Librería cargada! (DEMO desactivada)")
    print("💡 Para activar la demo, cambia DEMO_ACTIVO = true")
end
