...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    --// FIX REAL: Crear ChatRoot para separar mensajes del footer
    ...
    --// ScrollingFrame para mostrar mensajes (dentro de ChatRoot)
    ...
    --// Footer para input y botón (separado del ChatContainer)
