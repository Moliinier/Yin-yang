...
local ThemeBackgroundImages = {
    ...
    Purple = "rbxassetid://112714301994517",
    Orange = "rbxassetid://90056518364273",
...
if DEMO_ACTIVO then
    ...
    -- =========================================================
    -- TAB TEMAS (PROTEGIDA Y PERMANENTE - 18+ TEMAS)
    -- =========================================================
    ...
    local temas = {
        ...
        "Green", "Purple", "Orange", "NaranjaV1", "VioletaV1"
    }
    ...
    TabEfectos:CreateButton("Blanco - Celeste", function()
        ...
        print("Efecto: WhiteCyan")
    end)
    
    TabEfectos:CreateButton("Blanco - Rosa", function()
        DemoUI:SetTextEffect("WhitePink")
        print("Efecto: WhitePink")
    end)
    
    TabEfectos:CreateButton("Arcoiris", function()
    ...
    TabEfectos:CreateButton("Desactivar Efectos", function()
        DemoUI:SetTextEffect("Off")
        print("Efectos desactivados")
    end)
    
    print("\n✅ DEMO INICIADA")
    print("TABS: Inicio (Protegida) | Temas (18+ colores) | Features | Dropdowns | Efectos")
    print("NUEVOS: NaranjaV1, VioletaV1, Rainbow Efecto")
    print("Para desactivar la demo, cambia DEMO_ACTIVO a false\n")
    print(string.rep("=", 60) .. "\n")
else
    print("Yin Yang v22 - DEMO DESACTIVADA (DEMO_ACTIVO = false)")
